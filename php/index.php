<?php
	include 'private/validation_functions.php'; //Evaluation metrics
	$firstName = "";
	$lastName = "";
	$email = "";
	$username = "";
	...
	function isSubmitted() {
		if (strlen($_POST["firstName"]) || strlen($_POST["lastName"]) || strlen($_POST["email"]) || strlen($_POST["username"])) {
			return true;
		}
		return false;
	}
	...
	function errorCheck($firstName, $lastName, $email, $username){
		if(isSubmitted()){
...
<html>
<head>
	<title>Globitek Registration</title>
...
<div class="container">
	...
	<?php
	errorCheck($firstName, $lastName, $email, $username);
